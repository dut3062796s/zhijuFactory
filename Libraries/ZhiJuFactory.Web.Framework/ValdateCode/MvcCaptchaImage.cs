...
namespace TY.Web.Framework.ValdateCode
{
    ...
    public class MvcCaptchaImage
    {
        ...
        public static MvcCaptchaImage GetCachedCaptcha(string guid)
        {
            if (String.IsNullOrEmpty(guid))
                return null;
            //var img = (MvcCaptchaImage)HttpContext.Current.Session[guid]; 获取出来的为null 需要修改
            var img = (MvcCaptchaImage)HttpContext.Current.Session[guid];
            return img;
        }
        ...
        public  MvcCaptchaImage():this(new MvcCaptchaOptions()){}

        public  MvcCaptchaImage(MvcCaptchaOptions options)
        {
