...
namespace TY.Web.Framework
{
    ...
    public class BaseWebApiController : BaseController
    {
        /// <summary>
        /// 从配置文件中获取上传文件路径
        /// </summary>
        ...
        protected override void Initialize(HttpControllerContext controllerContext)
        {
            ...
            //HttpCookie authCookie = controllerContext.RequestContext.[FormsAuthentication.FormsCookieName];
            //if (authCookie != null)
            //{
        ...
        {
            object value = ControllerContext.RouteData.Values[key];
            if (value != null)
        ...
        {
            return TypeHelper.ObjectToInt(ControllerContext.RouteData.Values[key], defaultValue);
        }
        ...
        /// <returns></returns>
        protected async Task<string> AjaxResult(string code, string message, string url = null)
        {
            ...
            return await Task.Factory.StartNew(() => JsonConvert.SerializeObject(result, jsetting));
        }
        /// <summary>
        /// ajax请求结果
        /// </summary>
        ...
        /// <param name="message">内容</param>
        /// <returns></returns>
        protected async Task<string> AjaxResult(string code, AjaxObjResult[] message, string url = null)
        {
